...
use crate::util::{serialize_semver_req_opt, deserialize_semver_req_opt};
...
#[derive(Clone, Serialize, Deserialize)]
pub struct Version {
    #[serde(serialize_with="serialize_semver_req_opt", deserialize_with="deserialize_semver_req_opt", default)]
